function [ cropped_fov, cropped_mask ] = crop_fov( I, mask )
...
%   Detailed explanation goes here
    ...
    cropped_fov = uint8(zeros(y_gradient(2) - y_gradient(1) + 1, x_gradient(2) - x_gradient(1) + 1, size(I,3)));
    for i = 1 : size(I,3)
        cropped_fov(:,:,i) = I(y_gradient(1):y_gradient(2), x_gradient(1):x_gradient(2), i);
    end
    cropped_mask = mask(y_gradient(1):y_gradient(2), x_gradient(1):x_gradient(2));
